...
void xInitD3d()
{
	...
	style->Colors[ImGuiCol_WindowBg] = ImColor(0, 0, 0); // background
	...
	style->Colors[ImGuiCol_Border] = ImColor(0.0f, 0.65f, 0.100f); // border
	...
	style->Colors[ImGuiCol_TitleBg] = ImColor(0, 0, 0); // uzraso galas background
	style->Colors[ImGuiCol_TitleBgActive] = ImColor(0, 0, 0); // uzraso galas lietimas
	style->Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.1450980454683304f, 0.1450980454683304f, 0.1450980454683304f, 1.0f);
	style->Colors[ImGuiCol_MenuBarBg] = ImColor(0, 0, 0); // menu bar bg
	style->Colors[ImGuiCol_ScrollbarBg] = ImColor(0, 0, 0); // scroll bar
	style->Colors[ImGuiCol_ScrollbarGrab] = ImColor(0.0f, 0.65f, 0.100f); // scroll bar
	style->Colors[ImGuiCol_ScrollbarGrabHovered] = ImColor(0.0f, 0.65f, 0.100f);
	style->Colors[ImGuiCol_ScrollbarGrabActive] = ImColor(0.0f, 0.65f, 0.100f);
	style->Colors[ImGuiCol_CheckMark] = ImColor(0.0f, 0.65f, 0.100f); // checkmark
	style->Colors[ImGuiCol_SliderGrab] = ImColor(0.0f, 0.65f, 0.100f); // slider 
	style->Colors[ImGuiCol_SliderGrabActive] = ImColor(0.0f, 0.65f, 0.100f); // slider active
	style->Colors[ImGuiCol_Button] = ImVec4(0.0f, 0.65f, 0.100f, 1.0f); // button
	style->Colors[ImGuiCol_ButtonHovered] = ImVec4(1.0f, 1.0f, 1.0f, 0.1560000032186508f);
	style->Colors[ImGuiCol_ButtonActive] = ImVec4(0.0f, 0.65f, 0.100f, 1.0f); // buttom active green
...
void DrawESP()
{
	...
	{
		char dist[256];
		sprintf_s(dist, "posted for patrukes | FPS %.f\n", ImGui::GetIO().Framerate);
	   ...
	   // if (read<float>(CurrentActor + OFFSETS::Revivefromdbnotime) != 10) continue;
		...
		if (distance < VisDist)
		{
			...
			if (Esp)
			{
				...
				if (Esp_Line_Bottom){ 	// Esp_LineBottom bottom screen
				...
				if (Crosshair_Lines)// CrosshairLines
				{
...
void render()
{
	...
	if (ShowMenu)
	{
		ImGui::Begin(" Free skid", 0, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize);
		...
		if (maintabs == 0)
		{
			...
			ImGui::SameLine();
			ImGui::Checkbox("Filled Fov", &Filled_Fov);
			...
			ImGui::Spacing();
			ImGui::SliderFloat("Aimbot Smoothness", &smooth, 1.0f, 15.0f);
			ImGui::Spacing();
		...
		if (maintabs == 1)
		{
			...
			ImGui::Spacing();
			ImGui::Checkbox("3D Box", &Box_3D); 


			ImGui::SameLine(200.200);
			ImGui::Checkbox("add what you like", &Esp_Line_Top);
			...
			ImGui::SameLine(200.200);
			ImGui::Checkbox("Esp Line Bottom", &Esp_Line_Bottom); 
			...
			ImGui::SameLine(200.200);
			ImGui::Checkbox("Target Line", &Crosshair_Lines); 
		...
		if (maintabs == 2)
		{
			...
			ImGui::SliderFloat(("Box Thickness"), &BoxThickness, 0.f, 5);
			ImGui::SliderFloat(("Cornered Thickness"), &CorneredThickness, 0.f, 5);
			ImGui::SliderFloat(("Skeleton Thickness"), &Skeleton_Thickness, 0.f, 5);
			ImGui::SliderFloat(("Buttom Line Thickness"), &ButtomLineThickness, 0.f, 5);
			...
			ImGui::Text(" Visible Colors");

			ImGui::ColorEdit3(TEXT("Box Visible "), PlayerColor::BoxVisible);

			ImGui::ColorEdit3(TEXT("Cornered Visible "), PlayerColor::CorneredVisible);

			ImGui::ColorEdit3(TEXT("Skeleton Visible "), PlayerColor::SkeletonVisible);

			ImGui::ColorEdit3(TEXT("Buttom Line Visible "), PlayerColor::ButtomLineVisible);

			ImGui::ColorEdit3(TEXT("Fov Circle "), PlayerColor::FovCircle1Visible);
			...
			ImGui::Text(" Not Visible Colors");

			ImGui::ColorEdit3(TEXT("Box Not Visible "), PlayerColor::BoxNotVisible);

			ImGui::ColorEdit3(TEXT("Cornered Not Visible "), PlayerColor::CorneredNotVisible);

			ImGui::ColorEdit3(TEXT("Skeleton Not Visible "), PlayerColor::SkeletonNotVisible);

			ImGui::ColorEdit3(TEXT("Buttom Line Not Visible "), PlayerColor::ButtomLineNotVisible);
